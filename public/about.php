    ...
    <section class="well sevices">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <?php
            $getNews = "SELECT news_id, news_title, news_details, date_created FROM news";
            ...
            foreach ($getNews as $assocKey => $details) {
                ...
                $newsLink = $fxns->_readMore(strip_tags(html_entity_decode($details['news_details'])), 50, $readMoreLink);
